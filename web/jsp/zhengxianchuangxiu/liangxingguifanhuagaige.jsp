...
<script>
    ...
    function successCallBack(responseData){
        if(responseData.result == "0") {
            window.location.href = "<%=basePath%>/jsp/zhengxianchuangxiu/liangxingguifanhuagaige.jsp";
        }else{
    ...
    function addNew(){
        ...
        var sendData = {"title": accountInput, "sub": subSelect, "content": fContentData, "flag": Flag, "owner": "7"};
