...
<script>
    ...
    function successCallBack(responseData){
        if(responseData.result == "0") {
            window.location.href = "<%=basePath%>/jsp/court_situation/court_introduction.jsp";
        }else{
    ...
    function addNew(){
        ...
        var sendData = {"title": accountInput, "sub": subSelect, "content": fContentData, "flag": Flag, "owner": "2"};
